...
每天自动采集 AI 新闻，完成硬去重、跨来源语义合并、中文摘要、分类和重要性排序，将符合证据门槛的内容编入日报，并在北京时间每天 9:00 发送到飞书“AI 增长内部群”。默认使用 GitHub Actions，因此不需要单独购买服务器。
...
3. 若近 36 小时没有候选通过初筛，自动扩展到最近 7 天，并保留每条内容的真实发布日期。
